    ...
    class Program
    {
        ...
        private static void feladat7()
        {
            ...
            for (int i = 0; i < adatok.Count; i++)
            {
                ...
                {
                    ora = adatok[i].versenyidoO;
                    perc = adatok[i].versenyidoP;
                    msperc = adatok[i].versenyidoS;


                    idoOrabanOssz = idoOrabanOssz + IdoOraban(ora, perc, msperc);
                    osszFerfi++;
        ...
        private static float IdoOraban(float ora, float perc, float msperc)
        {


            float teljesIdoOraban = ora + (perc / 60) + (msperc / 3600);
        ...
        private static void feladat2()
        {
            ...
            StreamReader olvasocsatorna = new StreamReader(@"Z:\Programozas_C\Ultrabalaton\ub2017egyeni.txt", true);
